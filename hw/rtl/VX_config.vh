...
`define MMIO_VIRGO_SIZE       32'h00000800
`define MMIO_BASE_ADDR  32'h00010000 - `MMIO_SIZE           
`define MMIO_WRITE_ADDR MMIO_BASE_ADDR
`define MMIO_BASE_READ_ADDR MMIO_WRITE_ADDR + 32'h00000100
`define MMIO_END_ADDR   USER_BASE_ADDR
`endif
...
`define MMIO_VIRGO_END_ADDR         USER_VIRGO_BASE_ADDR
`endif
